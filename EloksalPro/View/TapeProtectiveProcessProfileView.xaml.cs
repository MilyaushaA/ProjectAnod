...
{
    /// <summary>
    /// Логика взаимодействия для TapeProtectiveProcessProfileView.xaml
    /// </summary>
    public partial class TapeProtectiveProcessProfileView : Window
    {
        public TapeProtectiveProcessProfileView()
        {
            InitializeComponent();
