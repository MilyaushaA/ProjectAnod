...
{
    /// <summary>
    /// Логика взаимодействия для DetailReceptionMaterialsView.xaml
    /// </summary>
    public partial class DetailReceptionMaterialsView : Window
    {
        public DetailReceptionMaterialsView()
        {
            InitializeComponent();
        ...
        private void TableView_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            ...
            txtIdNomenclature.Text = id.ToString();
        }
